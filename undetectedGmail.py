...
driver.find_element(By.ID,"identifierId").send_keys("enter your gmail here")
...
driver.find_element(By.CSS_SELECTOR, password_selector).send_keys("enter gmail password here")
